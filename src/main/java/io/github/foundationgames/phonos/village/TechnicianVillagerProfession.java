...
public enum TechnicianVillagerProfession {;
    ...
    public static final VillagerProfession TECHNICIAN_PROFESSION = VillagerProfessionBuilder.create().id(Phonos.id("technician")).workSound(SoundEvents.BLOCK_DISPENSER_FAIL).workstation(RegistryKey.of(Registry.POINT_OF_INTEREST_TYPE_KEY, Phonos.id("technician_job_site"))).build();
